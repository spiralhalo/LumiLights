...
void foamPreprocess(inout vec4 albedo, inout vec3 material, sampler2D natureTexture, vec3 worldPos, vec3 albedoSolid, float dSolid, float dTrans)
{
	...
	albedo.a *= smoothstep(0.0, 0.0625, dZ);
