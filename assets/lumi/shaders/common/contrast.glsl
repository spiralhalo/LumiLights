...
// ******************************
	...
	#define DEF_SUNLIGHT_STR		10.5 * USER_SUNLIGHT_MULTIPLIER
	#define DEF_NOON_AMBIENT_STR	3.0 * USER_NOON_AMBIENT_MULTIPLIER
#else
	#define SUN_AMBIENT_MULT		(USER_SUNLIGHT_MULTIPLIER + USER_NOON_AMBIENT_MULTIPLIER) * 0.5
	#define DEF_SUNLIGHT_STR		6.0 * SUN_AMBIENT_MULT
	#define DEF_NOON_AMBIENT_STR	6.0 * SUN_AMBIENT_MULT
#endif
	...
	const vec3 SKYLESS_LIGHT_COLOR		= vec3(0.5);
